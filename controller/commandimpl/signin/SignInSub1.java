...
public class SignInSub1 implements Command {
    private static final SignInSub2 sub2 = new SignInSub2();
    private static final String commandPath = "executor?command=sign_in&subcommand=2";
