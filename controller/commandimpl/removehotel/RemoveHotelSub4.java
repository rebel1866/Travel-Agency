...
public class RemoveHotelSub4 implements Command {
    private static final String commandPath = "executor?command=remove_hotel&subcommand=main&hotel_id=";
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect(commandPath + request.getParameter(hotelIdParam));
    }
}
